...
#define DMA1EN						(1U<<21)
#define CHSEL4						(1U<<27)
#define DMA_MEN_INC					(1U<<10)
#define DMA_DIR_MEN_TO_PERIPH		(1U<<6)
#define DMA_CR_TCIE					(1U<<4) /*(1U<<14)*/
...
void dma1_stream6_int(uint32_t src, uint32_t dst, uint32_t len)
{
	...
	DMA1_Stream6->CR |= DMA_MEN_INC;


	/*Configure transfer direction*/
	DMA1_Stream6->CR |= DMA_DIR_MEN_TO_PERIPH;
